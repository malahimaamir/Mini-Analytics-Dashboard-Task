...
export default function Register({ onAuth }: { onAuth: () => void }) {
  ...
  return (
    <div className=" flex items-center justify-center p-4  ">
      <div className="w-full max-w-md bg-surface shadow-2xl rounded-3xl p-8 border border-border relative overflow-hidden bg-gradient-to-b from-purple-600 via-pink-500 to-indigo-400 animate-fadeInUp">
